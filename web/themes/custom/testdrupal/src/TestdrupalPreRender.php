...
namespace Drupal\testdrupal;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the testdrupal theme.
 *
 * @internal
 */
class TestdrupalPreRender implements TrustedCallbackInterface {
